...
export const EnemySpawnList = {
  ...
  dustVale: [
    ...
    new Position('axolot', 1180, 710),
    new Position('skull', 2290, 1700),
    new Position('spirit', 1600, 1500),
  ],
  duskWatch: [
  ...
  emeraldRift: [
    ...
    new Position('eye', 2350, 1000),
    new Position('axolot', 1800, 1200),
  ...
  silentVeilNecropolis: [
    ...
    new Position('axolot', 630, 880),
    new Position('skull', 1500, 1200),
