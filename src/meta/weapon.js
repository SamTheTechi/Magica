export const WeaponMetaData = {
  axe: {
    ...
    Image: Object.assign(new Image(), {
      src: "./Items/Weapons/Axe/Sprite.png",
    }),
  ...
  bow: {
    ...
    damage: 0,
    Image: Object.assign(new Image(), {
      src: "./Items/Weapons/Bow/Sprite.png",
    }),
  ...
  shuriken: {
    ...
    icon: Object.assign(new Image(), {
      src: "./Items/Weapons/Shuriken/icon.png",
    }),
    ani: "slash",
    Projectile: {
      Image: Object.assign(new Image(), {
        src: "./FX/Projectile/Shuriken.png",
      }),
      ani: "slash",
      damage: 10,
      height: 16,
  ...
  sword: {
    ...
    damage: 15,
    Image: Object.assign(new Image(), {
      src: "./Items/Weapons/Sword/Sprite.png",
    }),
  ...
  staff: {
    ...
    damage: 0,
    Image: Object.assign(new Image(), {
      src: "./Items/Weapons/Staff/Sprite.png",
    }),
    icon: Object.assign(new Image(), { src: "./Items/Weapons/Staff/icon.png" }),
    ani: "flame",
    Projectile: {
      Image: Object.assign(new Image(), {
        src: "./FX/Projectile/Fireball.png",
      }),
      damage: 30,
      ani: "flame",
      height: 16,
  ...
  spear: {
    ...
    damage: 30,
    Image: Object.assign(new Image(), {
      src: "./Items/Weapons/Spear/Sprite.png",
    }),
